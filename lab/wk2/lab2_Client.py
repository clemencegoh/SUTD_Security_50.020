...
def sol2(i=0):
    ...
    # if len(mask) < 140:
    #     mask += int(0).to_bytes(msg_length - i, 'big') 
    
    # new_mask = b''
    
    # if len(mask) < 33:
    #     mask += int(0).to_bytes(33-i, 'big')
